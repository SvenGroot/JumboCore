...
public partial class LineCount : JobBuilderJob
{
    ...
    /// The input path.
    /// </value>
    [CommandLineArgument(IsPositional = true), Description("The input file or directory containing the text to perform the line count on.")]
    ...
    /// The output path.
    /// </value>
    [CommandLineArgument(IsPositional = true), Description("The output directory where the results will be written.")]
