...
public partial class ValSort : JobBuilderJob
{
    ...
    /// The input path.
    /// </value>
    [CommandLineArgument(IsPositional = true), Description("The input file or directory containing the data to validate.")]
    ...
    /// The output path.
    /// </value>
    [CommandLineArgument(IsPositional = true), Description("The output directory where the results of the validation will be written.")]
    ...
    /// </value>
    [CommandLineArgument, JobSetting, Description("Enables verbose logging of where unsorted records occurred in the combiner task.")]
