...
public partial class TeraSort : JobBuilderJob
{
    ...
    /// The input path.
    /// </value>
    [CommandLineArgument(IsPositional = true), Description("The input file or directory containing the data to be sorted.")]
    ...
    /// The output path.
    /// </value>
    [CommandLineArgument(IsPositional = true), Description("The output directory where the sorted data will be written.")]
    ...
    /// The merge tasks.
    /// </value>
    [CommandLineArgument(IsPositional = true, DefaultValue = 0), Description("The number of merge tasks to use. The default value is the cluster capacity.")]
