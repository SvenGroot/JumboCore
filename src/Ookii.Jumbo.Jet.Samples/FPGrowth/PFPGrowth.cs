...
public partial class PFPGrowth : JobBuilderJob
{
    ...
    /// The input path.
    /// </value>
    [CommandLineArgument(IsPositional = true), Description("The input file or directory containing the transaction database. The database should be a plain text file where each line is a transaction containing a space-separated list of items.")]
    ...
    /// The output path.
    /// </value>
    [CommandLineArgument(IsPositional = true), Description("The output directory where the result will be written.")]
