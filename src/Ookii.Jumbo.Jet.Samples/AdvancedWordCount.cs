...
public partial class AdvancedWordCount : JobBuilderJob
{
    ...
    /// The input path.
    /// </value>
    [CommandLineArgument(IsPositional = true), Description("The input file or directory containing the input text (must be utf-8).")]
    ...
    /// The output path.
    /// </value>
    [CommandLineArgument(IsPositional = true), Description("The directory where the output will be written.")]
