...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StageStatus"/> class.
    /// </summary>
    public StageStatus()
    {
    }
    ...
    /// </summary>
    public List<TaskStatus> Tasks { get; } = new();

    // Used only if the JobStatus was created with JobStatus.FromXml(). It's a property so the
    // generated value writer will serialize it.
    private TaskMetrics? StageMetrics { get; set; }
