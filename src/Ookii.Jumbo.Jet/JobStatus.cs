...
public partial class JobStatus
{
    ...
    /// </summary>
    public List<StageStatus> Stages { get; } = new();

    /// <summary>
    /// Gets the task attempts that failed.
    /// </summary>
    public List<TaskStatus> FailedTaskAttempts { get; } = new();

    /// <summary>
    /// Gets the additional progress counters.
    /// </summary>
    /// <value>The additional progress counters.</value>
    public List<AdditionalProgressCounter> AdditionalProgressCounters { get; } = new();
    ...
    {
        return (from counter in AdditionalProgressCounters
    ...
    public static JobStatus FromXml(XElement job)
    {
        ...
        foreach (var stage in stages)
        {
            var stageStatus = new StageStatus() { StageId = stage.Key };
        ...
        var metricsElement = job.Element("StageMetrics");
